...
```html
![](https://gulinall-hkw.oss-cn-shenzhen.aliyuncs.com/6bec83c2-2406-43b4-8eb8-96a9d3ccb113.jpg)
```
...
<body>
    ...
    <a href="http://www.itheima.com" target="_blank">![](https://gulinall-hkw.oss-cn-shenzhen.aliyuncs.com/0b4c135d-3ae4-443d-bb5d-0a530587c202.png)</a>
</body>
</html>
```
...
![](https://gulinall-hkw.oss-cn-shenzhen.aliyuncs.com/ac3b994f-3580-4771-95fb-8a171811635a.png)
<span>微信</span>
```
...
<body>
    <!--顶部公司图标-->
    <div>
        ![](https://gulinall-hkw.oss-cn-shenzhen.aliyuncs.com/acf4181e-7853-4104-bc87-67ddd1f1a3d1.png)
    </div>
...
* 响应体：页面展示内容, 类似网页的源码
  ...
  <html>
      ...
      <body>
          ![](https://gulinall-hkw.oss-cn-shenzhen.aliyuncs.com/fab5ff01-1089-4afb-99d6-d3442d5f4737.jpg)
      </body>
  </html>
  ```
