...
![img](./assets/bcc66999c2e0ecfff2d1d355877443c1.png)
...
![img](./assets/ab1b7059814506f7906ed8cea42d44fe.png)
...
![img](./assets/f55dea69880731c583d9d58b837a94ed.png)
...
![img](./assets/7d74f7e42c0559aa288c687a41675fca.png)
...
**概念：**又叫生成器模式，是一种对象构建模式，允许用户只制定复杂对象的类型和内容就行，不需要知道内部的具体构建细节，包含产品角色，抽象建造者，具体建造者，指挥者
...
![img](./assets/710bc945fad5959058e1fbcf72ab9d33.png)
...
![img](./assets/ea17e702d9146262b7309a217370657b.png)
...
![img](./assets/0dcc81174da80f2ce92a3d8e35097f7d.png)
...
![img](./assets/34957103e5fe66b88ac56ca29fe8b0a4.png)
...
![img](./assets/2deda7644703b508c7097acd3d947e57.png)
...
![img](./assets/0a4fc69c0c255c4a3b5bc9ca0b4cac7e.png)
...
![img](./assets/638c6e9ee7f3856471355fc52ba84734.png)
...
![img](./assets/ef73400d12913fdb6d199d2c723ab3d1.png)
...
![img](./assets/96d97a34cd0d0ca5ac51ab5c9b337cdc.png)
...
**CGLIB 原理**：动态生成一个要代理的子类，子类重写要代理的类的所有不是 final 的方法。在子类中采用拦截的技术拦截所有父类方法的调用，顺势植入横切逻辑。比使用 Java 反射的 JDK 动态代理要更快

**CGLIB 缺点**：对应 final 方法，无法代理
...
参数：Object 为由 CGLIB 动态生成的代理类实例，Method 为上文中实体类所调用的被代理的方法引用，Object[] 为参数列表，MethodProxy 为生成的代理类对方法的代理引用

返回：从代理实例的方法调用返回的值

其中，proxy.involeSuper(obj, arg) 调用代理类上的 Proxy 方法的父类方法（即实体类TargetObject 中对应的方法）
...
这里Enhancer 类是CGLib 中一个字节码增强器，它可以方便对你想处理的类进行扩展，以后会经常看到

首先被代理类 TargetObject 设置为父类，然后设置拦截器 TargetInterceptor，最后执行 enhancer.create()动态生成一个代理类，并从 Object强制转型成父类型 TargetObject
...
![img](./assets/09ed93cd1aac1d9900ee9d08dd03674a.png)
...
![img](./assets/76328152179fecaa7d1d8b6dff915dde-20251117092132943.png)
...
![img](./assets/fff2ec035c37c29bd79bd3536d868d28.png)
...
![img](./assets/1fd04e98ddd73c8fe4cbac76c4bea3ff.png)
...
![img](./assets/87e4b3831daf3db29038d60882e35066.png)

**桥接模式结构和代码实例**

![img](./assets/e0a9ddaa7a9e8fa2b4b4423830083931.png)

**实现**

![img](./assets/7621c3b26e8703fe19aeb0c39fd4e88f.png)
...
![img](./assets/195f8099e87c129be14bf15425dfdc45.png)
...
- 树枝构件（Composite）角色：是组合中的分支节点对象，它有子节点。它实现了抽象构件角色中声明的接口，它的主要作用是存储和管理子部件，通常包含 Add()、Remove()、GetChild() 等方法
  ![img](./assets/6f432d11cc26732585672df146e7b0f9.png)
...
![img](./assets/85bd1e40a3d305874d570a9501221157.png)
...
![img](./assets/b01599c33195ec2e5dfe5d6aa5e674a4.png)
...
![img](./assets/b8df037feeccdda1679f8596e282243f.png)
...
举例如下（ 实现一个加减的功能），类图如下：
![img](./assets/5120ffc0648fa5ce2364b2ad256edd05.png)
...
![img](./assets/9ebb5bd5613e133f078cbac1c7799fe7.png)
...
![img](./assets/0feb05d25d6736ddc98b41088b2aa972.png)
...
![img](./assets/548c79338a08bd70b5108930e2043f9d.png)
...
![img](./assets/6d39fe0a556e36bf9bb42b14ea8aad53.png)
...
![img](./assets/a21d8ad95923e7494ad7ccca8d699853.png)
...
![img](./assets/9a483b54c51834a7ae720ea0dbe8e6c9.png)
...
![img](./assets/4cba3e46d2bb7b4f7caf58a1fb770675.png)
...
![img](./assets/6a744ed2903620a06ea12b6573cfe311.png)
...
![img](./assets/621f3867913eb39dcf79ae54679e6cb8.gif)
...
![img](./assets/c88fb350b83ae49156eb48ebb7a4ec64.png)
...
![img](./assets/f9901b89cc896259da1d9dc32d838e1b.png)
...
![img](./assets/1e38636976dfb433c64c98daafdd9d47.png)
...
![img](./assets/132b39bb8cbadafc3f5f3717c45d50ad.png)
...
![img](./assets/606273178aa0cf2126bde9ccf4c0453b.gif)
