...
>
> ![](https://gulinall-hkw.oss-cn-shenzhen.aliyuncs.com/bf83f848-f187-49d3-b7d2-c6b4b5a8a0f1.png)
>
> **论文引用**：
>
> ```
> @article{xiong2025region,
>   title={Region-guided spatial feature aggregation network for vehicle re-identification},
>   author={Xiong, Yanzhen and Peng, Jinjia and Tao, Zeze and Wang, Huibing},
...
> **axiv **2025. [(PDF)](/Users/huangkaiwen/Desktop/Paper/vehicle-reid/2025-idea-ReID.pdf) [link](https://scholar.google.com/scholar?hl=zh-CN&as_sdt=0%2C5&q=IDEA%3A+Inverted+Text+with+Cooperative+Deformable+Aggregation+for+Multi-modal+Object+Re-Identification&btnG=)
>
> ![](https://gulinall-hkw.oss-cn-shenzhen.aliyuncs.com/a927396f-7cb8-4c2e-9ac9-57552e189c75.png)
>
> **论文引用**：
>
> ```
...
> **Expert Systems With Application **2025. [(PDF)](/Users/huangkaiwen/Desktop/Paper/vehicle-reid/2025-WTSF-ReID.pdf) [link](https://scholar.google.com/scholar?hl=zh-CN&as_sdt=0%2C5&q=WTSF-ReID%3A+Depth-driven+Window-oriented+Token+Selection+and+Fusion+for+multi-modality+vehicle+re-identification+with+knowledge+consistency+constraint&btnG=)
>
> ![](https://gulinall-hkw.oss-cn-shenzhen.aliyuncs.com/059cc4dc-b7b3-4d39-b581-a56ae9e5bc7d.png)
>
> **论文引用**：
>
> ```
...
> **Expert Systems With Application**,2024. [(PDF)](/Users/huangkaiwen/Desktop/Paper/vehicle-reid/2024-vcgr-ReID.pdf) [link](https://scholar.google.com/scholar?hl=zh-CN&as_sdt=0%2C5&q=Vision-language+constraint+graph+representation+learning+for+unsupervised+vehicle+re-identification&btnG=)
>
> ![](https://gulinall-hkw.oss-cn-shenzhen.aliyuncs.com/ae7c9978-9a2d-4631-b87d-d78505965ca7.png)
>
> **论文引用**：
>
> ```
> @article{sun2024adversarial,
>   title={Adversarial Style-Irrelevant Feature Learning With Refined Soft Pseudo Labels for Domain-Adaptive Vehicle Re-Identification},
>   author={Sun, Wei and Hu, Yahua and Zhang, Xiaorui and Yao, Xin and He, Xiaozheng},
...
> **IEEE Tans on Intelligent transport systems**,2024. [(PDF)](/Users/huangkaiwen/Desktop/Paper/vehicle-reid/2024-asfl-ReID.pdf) [link](https://scholar.google.com/scholar?hl=zh-CN&as_sdt=0%2C5&q=Adversarial+Style-Irrelevant+Feature+Learning+With+Refined+Soft+Pseudo+Labels+for+Domain-Adaptive+Vehicle+Re-Identification&btnG=)
>
> ![](https://gulinall-hkw.oss-cn-shenzhen.aliyuncs.com/f9513988-f2b4-4070-be65-4a6669c7ce04.png)
>
> **论文引用**：
>
> ```
...
> **Knowledge-Based Systems **2024. [(PDF)](/Users/huangkaiwen/Desktop/Paper/vehicle-reid/2024-AIVR-Net.pdf) [link](https://scholar.google.com/scholar?hl=zh-CN&as_sdt=0%2C5&q=AIVR-Net%3A+Attribute-based+invariant+visual+representation+learning+for+vehicle+re-identification&btnG=)
>
> ![](https://gulinall-hkw.oss-cn-shenzhen.aliyuncs.com/fbb6047f-8cfc-438e-b0fa-5cbfded95b48.png)
>
> **论文引用**：
>
> ```
> @article{zhang2024aivr,
>   title={AIVR-Net: Attribute-based invariant visual representation learning for vehicle re-identification},
>   author={Zhang, Hongyang and Kuang, Zhenyu and Cheng, Lidong and Liu, Yinhao and Ding, Xinghao and Huang, Yue},
...
> **Engineering Applications of Artificial Intelligence **2024. [(PDF)](/Users/huangkaiwen/Desktop/Paper/vehicle-reid/2024-TANet- Text region attention learning for vehicle re-identification.pdf) [link](https://scholar.google.com/scholar?hl=zh-CN&as_sdt=0%2C5&q=TANet%3A+Text+region+attention+learning+for+vehicle+re-identification&btnG=)
>
...
> **IEEE Transactions on Intelligent Vehicles** [(PDF)](/Users/huangkaiwen/Desktop/Paper/vehicle-reid/2024-A_Blockchain-Enabled_Distributed_System_for_Trustworthy_and_Collaborative_Intelligent_Vehicle_Re-Identification.pdf) [link](https://scholar.google.com/scholar?hl=zh-CN&as_sdt=0%2C5&q=A+Blockchain-Enabled+Distributed+System+for+Trustworthy+and+Collaborative+Intelligent+Vehicle+Re-Identification&btnG=)
>
> ![](https://gulinall-hkw.oss-cn-shenzhen.aliyuncs.com/1408c378-fd1b-483f-8695-c3ed29807ea8.png)
>
> **论文引用**：
>
> ```
> @article{wang2023blockchain,
>   title={A Blockchain-enabled Distributed System for Trustworthy and Collaborative Intelligent Vehicle Re-identification},
>   author={Wang, Shuai and Yang, Da and Sheng, Hao and Shen, Jiahao and Zhang, Yang and Ke, Wei},
...
> **IEEE Transactions on Intelligent Transportation Systems **2024. [(PDF)](/Users/huangkaiwen/Desktop/Paper/vehicle-reid/2024-Multi-Branch_Enhanced_Discriminative_Network_for_Vehicle_Re-Identification.pdf) **[link](https://scholar.google.com/scholar?hl=zh-CN&as_sdt=0%2C5&q=Multi-Branch+Enhanced+Discriminative+Network+for+Vehicle+Re-Identification&btnG=) **
>
> ![](https://gulinall-hkw.oss-cn-shenzhen.aliyuncs.com/a8cd533d-7e64-4192-b825-c6f702f8d0e9.png)
>
> **论文引用**：
>
> ```
> @article{lian2023multi,
>   title={Multi-Branch Enhanced Discriminative Network for Vehicle Re-Identification},
>   author={Lian, Jiawei and Wang, Da-Han and Wu, Yun and Zhu, Shunzhi},
>   journal={IEEE Transactions on Intelligent Transportation Systems},
>   year={2023},
>   publisher={IEEE}
> }
...
#### ccDair-v2xreid: A new real-world vehicle-infrastructure cooperative re-id dataset and cross-shot feature aggregation network perception method

> **IEEE Transactions on Intelligent Transportation Systems **. [(PDF)](/Users/huangkaiwen/Desktop/Paper/vehicle-reid/2024-DAIR-V2XReid_A_New_Real-World_Vehicle-Infrastructure_Cooperative_Re-ID_Dataset_and_Cross-Shot_Feature_Aggregation_Network_Perception_Method.pdf) **[link](https://scholar.google.com/scholar?hl=zh-CN&as_sdt=0%2C5&q=DAIR-V2XReid%3A+A+New+Real-World+Vehicle-Infrastructure+Cooperative+Re-ID+Dataset+and+Cross-Shot+Feature+Aggregation+Network+Perception+Method&btnG=#d=gs_cit&t=1725270793202&u=%2Fscholar%3Fq%3Dinfo%3AQgTu_Dy-6BgJ%3Ascholar.google.com%2F%26output%3Dcite%26scirp%3D0%26hl%3Dzh-CN) **
>
> ![](https://gulinall-hkw.oss-cn-shenzhen.aliyuncs.com/208f2946-b2d5-49f4-84d9-38c01c09052b.png)
>
> **论文引用**：
>
> ```
> @article{wang2024dair,
>   title={Dair-v2xreid: A new real-world vehicle-infrastructure cooperative re-id dataset and cross-shot feature aggregation network perception method},
>   author={Wang, Hai and Niu, Yaqing and Chen, Long and Li, Yicheng and Sotelo, Miguel Angel and Li, Zhixiong and Cai, Yingfeng},
>   journal={IEEE Transactions on Intelligent Transportation Systems},
>   year={2024},
>   publisher={IEEE}
> }
...
> **Pattern Recognition. [(PDF)](/Users/huangkaiwen/Desktop/Paper/vehicle-reid/2022-Progressive learning with multi-scale attention network for cross-domain vehicle re-identification.pdf) **[link](https://scholar.google.com/scholar?hl=zh-CN&as_sdt=0%2C5&q=A+Dual+Self-Attention+mechanism+for+vehicle+re-Identification&btnG=#d=gs_cit&t=1725689297930&u=%2Fscholar%3Fq%3Dinfo%3ApAhZMQ2G4HAJ%3Ascholar.google.com%2F%26output%3Dcite%26scirp%3D0%26hl%3Dzh-CN) 
>
> **论文引用**：
>
> ```
...
> ```
>
> ![](https://gulinall-hkw.oss-cn-shenzhen.aliyuncs.com/0db6d4e7-1537-445a-9133-1a16dc7f992d.png)

#### A Dual-Branch Network for Few-Shot Vehicle Re-Identification With Enhanced Global and Local Features

> **IEEE Transactions on Instrumentation and Measurement. [(PDF)](/Users/huangkaiwen/Desktop/Paper/vehicle-reid/2023-A_Dual-Branch_Network_for_Few-Shot_Vehicle_Re-Identification_With_Enhanced_Global_and_Local_Features.pdf) **[link](https://scholar.google.com/scholar?hl=zh-CN&as_sdt=0%2C5&q=A+Dual-Branch+Network+for+Few-Shot+Vehicle+Re-Identification+With+Enhanced+Global+and+Local+Features&btnG=) 
>
> **论文引用**：
>
> ```
> @article{sun2023dual,
>   title={A Dual-Branch Network for Few-Shot Vehicle Re-Identification With Enhanced Global and Local Features},
>   author={Sun, Wei and Xu, Fan and Zhang, Xiaorui and Hu, Yahua and Dai, Guangzhao and He, Xiaozheng},
...
> ```
>
> ![](https://gulinall-hkw.oss-cn-shenzhen.aliyuncs.com/a9349308-dc5a-4e8d-aa58-a03934995116.png)
...
> ```
> 
> ![](https://gulinall-hkw.oss-cn-shenzhen.aliyuncs.com/09c964bb-ae55-4979-8e0c-10c2a4acecfa.png) 
...
> ```
> 
> ![](https://gulinall-hkw.oss-cn-shenzhen.aliyuncs.com/4c4ea640-2dd9-4998-9b38-68a6f2e3f872.png) 
...
> ```
> 
> ![](https://gulinall-hkw.oss-cn-shenzhen.aliyuncs.com/a99eaba5-0d3f-4c96-b6a2-8f91482d6a62.png) 
...
> ```
> 
> ![](https://gulinall-hkw.oss-cn-shenzhen.aliyuncs.com/67e2020e-f0af-4d91-b980-bc12beeb31ee.png) 
> 
...
> ```
>   
>![](https://gulinall-hkw.oss-cn-shenzhen.aliyuncs.com/04662afa-8a0d-42ff-b1ab-f3f8dc9cc682.png) 
...
> ```
>
> ![](https://gulinall-hkw.oss-cn-shenzhen.aliyuncs.com/bc766f05-df81-4d1d-b055-af416371a485.png) 
...
> **Science China Information Sciences, 2022.** [(PDF)](/Users/huangkaiwen/Desktop/Paper/vehicle-reid/2022-Progressive learning with multi-scale attention network for cross-domain vehicle re-identification.pdf) [link](https://scholar.google.com/scholar?hl=zh-CN&as_sdt=0%2C5&q=Progressive+learning+with+multi-scale+attention+network+for+cross-domain+vehicle+re-identification&btnG=)  
>
> **论文引用**：
>
> ```
> @article{wang2022progressive,
>   title={Progressive learning with multi-scale attention network for cross-domain vehicle re-identification},
>   author={Wang, Yang and Peng, Jinjia and Wang, Huibing and Wang, Meng},
...
> ```
>
> ![](https://gulinall-hkw.oss-cn-shenzhen.aliyuncs.com/e21eeed5-6978-4eb8-8a39-8a4e95462c0b.png)



#### Multi-attribute adaptive aggregation transformer for vehicle re-identification

> **Information Processing \& Management, 2022.** [(PDF)](/Users/huangkaiwen/Desktop/Paper/vehicle-reid/2022-Multi-attribute adaptive aggregation transformer for vehicle re-identification .pdf) [link](https://scholar.google.com/scholar?hl=zh-CN&as_sdt=0%2C5&q=Multi-attribute+adaptive+aggregation+transformer+for+vehicle+re-identification&btnG=#d=gs_cit&t=1725687963552&u=%2Fscholar%3Fq%3Dinfo%3Ac9k3epAVpSgJ%3Ascholar.google.com%2F%26output%3Dcite%26scirp%3D0%26hl%3Dzh-CN)  
>
> **论文引用**：
>
> ```
...
> ```
>
>   ![](https://gulinall-hkw.oss-cn-shenzhen.aliyuncs.com/6c7309de-2d84-450b-be46-1a05bf4cf5b4.png)
...
> ```
>
> <img src="https://gulinall-hkw.oss-cn-shenzhen.aliyuncs.com/dd86618a-5701-48b9-8195-3ebbecf87431.png" style="zoom:50%;" /> 
...
>
> ![](https://gulinall-hkw.oss-cn-shenzhen.aliyuncs.com/52462c99-d916-4713-9f5b-e04e48f9c358.png) 
> $$
...
> IEEE transactions on image processing, 2022. [(PDF)](/Users/huangkaiwen/Desktop/Paper/vehicle-reid/2022-Attribute_and_State_Guided_Structural_Embedding_Network_for_Vehicle_Re-Identification.pdf) [link](https://scholar.google.com/scholar?hl=zh-CN&as_sdt=0%2C5&q=Attribute+and+State+Guided+Structural+Embedding+Network+for+Vehicle+Re-Identification&btnG=)
>
> **论文引用**：
>
> ```
...
> ```
>
> ![](https://gulinall-hkw.oss-cn-shenzhen.aliyuncs.com/b56fb30f-11d6-444d-9e28-b9d872147ac2.png)
...
> ```
> 
> <img src="https://gulinall-hkw.oss-cn-shenzhen.aliyuncs.com/4ab952c2-9008-43c3-9b6b-220eb57ae932.png" style="zoom: 50%;" /> 

#### Model Latent Views With Multi-Center Metric Learning for Vehicle Re-Identification

IEEE TRANSACTIONS ON INTELLIGENT TRANSPORTATION SYSTEMS  [(pdf)](/Users/huangkaiwen/Desktop/Paper/vehicle-reid/2021_Model_Latent_Views_With_Multi-Center_Metric_Learning_for_Vehicle_Re-Identification.pdf)  [link](https://scholar.google.com/scholar?hl=zh-CN&as_sdt=0%2C5&as_ylo=2021&as_yhi=2024&q=Model+Latent+Views+With+Multi-Center+Metric+Learning+for+Vehicle+Re-Identification&btnG=)

![](https://gulinall-hkw.oss-cn-shenzhen.aliyuncs.com/b8f9f093-07c1-40b3-be75-968285c57345.png)
...
> ```
>
> ![](https://gulinall-hkw.oss-cn-shenzhen.aliyuncs.com/191281fe-a5ef-4fd3-810b-68bcf5cad759.png) 
...
> ```
>
> ![](https://gulinall-hkw.oss-cn-shenzhen.aliyuncs.com/750488b3-988f-4e16-8c10-43eaece4648b.png) 
...
> ```
>
> ![](https://gulinall-hkw.oss-cn-shenzhen.aliyuncs.com/eb1dc9a4-b4f9-4673-a1f4-2e4de923f1a6.png) 
...
> ```
>
> ![](https://gulinall-hkw.oss-cn-shenzhen.aliyuncs.com/c47a8c12-9af0-47d4-a1d6-cf296e9b5bdb.png) 
...
> **IEEE Transactions on Multimedia, 2021** [(PDF)](/Users/huangkaiwen/Desktop/Paper/2021-Exploiting_Multi-View_Part-Wise_Correlation_via_an_Efficient_Transformer_for_Vehicle_Re-Identification.pdf).  [link](https://scholar.google.com/scholar?hl=zh-CN&as_sdt=0%2C5&q=Exploiting+Multi-View+Part-Wise+Correlation+via+an+Efficient+Transformer+for+Vehicle+Re-Identification&btnG=#d=gs_cit&t=1725272540903&u=%2Fscholar%3Fq%3Dinfo%3Akc6XKq8_ShMJ%3Ascholar.google.com%2F%26output%3Dcite%26scirp%3D0%26hl%3Dzh-CN) 
>
> **论文引用**：
>
> ```
...
> ```
>
> ![](https://gulinall-hkw.oss-cn-shenzhen.aliyuncs.com/25e0aa0b-79b7-43f6-8160-68bb325a9e1b.png)

#### An efficient global representation constrained by Angular Triplet loss for vehicle re-identification

> **Pattern Analysis and Applications** [(PDF)](/Users/huangkaiwen/Desktop/Paper/vehicle-reid/2021-An efficient global representation constrained by Angular Triplet loss for vehicle re-identification.pdf).  [link](https://scholar.google.com/scholar?hl=zh-CN&as_sdt=0%2C5&q=Exploiting+Multi-View+Part-Wise+Correlation+via+an+Efficient+Transformer+for+Vehicle+Re-Identification&btnG=#d=gs_cit&t=1725272540903&u=%2Fscholar%3Fq%3Dinfo%3Akc6XKq8_ShMJ%3Ascholar.google.com%2F%26output%3Dcite%26scirp%3D0%26hl%3Dzh-CN) 
>
> **论文引用**：
>
> ```
> @article{gu2021efficient,
...
> ```
>
> ![](https://gulinall-hkw.oss-cn-shenzhen.aliyuncs.com/a9a3b034-d47d-46c9-a437-fbcb42746f0b.png)

## 2020

#### The devil is in the details: Self-supervised attention for vehicle re-identification

> **ECCV, 2020. [(PDF)](/Users/huangkaiwen/Desktop/Paper/vehicle-reid/2020-The Devil Is in the Details- Self-supervised Attention for Vehicle Re-identification.pdf) **[link](https://scholar.google.com/scholar?hl=zh-CN&as_sdt=0%2C5&q=The+Devil+Is+in+the+Details%3A+Self-supervised+Attention+for+Vehicle+Re-identification&btnG=#d=gs_cit&t=1725271029214&u=%2Fscholar%3Fq%3Dinfo%3AEvRpPJVhiSMJ%3Ascholar.google.com%2F%26output%3Dcite%26scirp%3D0%26hl%3Dzh-CN) 
>
> **论文引用**：
>
> ```
...
> ```
>
> ![](https://gulinall-hkw.oss-cn-shenzhen.aliyuncs.com/fe688d2c-77d5-4e09-b376-6e934d3d65f1.png)
...
> ```
>
> ![](https://gulinall-hkw.oss-cn-shenzhen.aliyuncs.com/f3ebc39e-cdff-43b8-b897-e8d0f481b648.png) 
...
> ```
>
> <img src="https://gulinall-hkw.oss-cn-shenzhen.aliyuncs.com/38131e57-aa7b-4d51-add1-d3fb2ab07d6f.png" style="zoom:50%;" /> 
>
> <img src="https://gulinall-hkw.oss-cn-shenzhen.aliyuncs.com/3da897ad-62f3-4d3c-8813-f2eb246a49e5.png" style="zoom:50%;" />
...
> ```
>
> <img src="https://gulinall-hkw.oss-cn-shenzhen.aliyuncs.com/aecc11c4-7287-476e-8289-d7b4056c053d.png" style="zoom:50%;" />style="zoom:33%;" />
...
> ```
>
> <img src="https://gulinall-hkw.oss-cn-shenzhen.aliyuncs.com/15305208-6602-4f27-9d31-485890b53676.png" style="zoom: 33%;" />
>
> <img src="https://gulinall-hkw.oss-cn-shenzhen.aliyuncs.com/d3c73e3e-27fd-4f72-bc8f-7da5e154b8e1.png" style="zoom:33%;" /> 
...
> ```
>
>  ![](https://gulinall-hkw.oss-cn-shenzhen.aliyuncs.com/380ce7b8-e273-4111-8655-29a8f4b4b26e.png)
...
> ```
>
> ![](https://gulinall-hkw.oss-cn-shenzhen.aliyuncs.com/9a3a2573-9e57-4eb6-9139-0d7a9392a677.png) 
...
> ```
>
> ![](https://gulinall-hkw.oss-cn-shenzhen.aliyuncs.com/ce01c0a4-2bba-4cce-bef4-b3c4ca69f573.png) 
...
> ```
>
> ![](https://gulinall-hkw.oss-cn-shenzhen.aliyuncs.com/96ec2d56-5fb1-4cb7-b4a5-62ab1b3b1f27.png) 
...
> ```
>
> ![](https://gulinall-hkw.oss-cn-shenzhen.aliyuncs.com/a51962f9-6ad6-4cff-83fc-a8d20f2b2dab.png)
...
>
> ![](https://gulinall-hkw.oss-cn-shenzhen.aliyuncs.com/de4d0436-adfb-4aca-840f-6894ae6f1051.png)
...
> ```
>
> ![](https://gulinall-hkw.oss-cn-shenzhen.aliyuncs.com/b825d907-3e82-4bb9-87f8-cc71b838202f.png) 
...
> ```
>
> ![](https://gulinall-hkw.oss-cn-shenzhen.aliyuncs.com/f48ebb42-e788-4eca-91a8-e5146ffca544.png) 
...
> ```
>
> ![](https://gulinall-hkw.oss-cn-shenzhen.aliyuncs.com/ec811b33-9847-44d4-9d65-0193fc819c22.png)
...
> **TIP, 2018. [(PDF)](/Users/huangkaiwen/Desktop/Paper/vehicle-reid/2018-Vehicle_Re-Identification_by_Deep_Hidden_Multi-View_Inference.pdf ) ** [link]https://scholar.google.com/scholar?hl=zh-CN&as_sdt=0%2C5&q=Vehicle+Re-Identification+by+Deep+Hidden+Multi-View+Inference&btnG=)【引用数 **130**】
>
> **论文引用**：
>
> ```
> @article{zhou2018vehicle,
...
> ```
>
> ![](https://gulinall-hkw.oss-cn-shenzhen.aliyuncs.com/731fec14-11d9-46b2-aa28-07b2fa04f9b3.png)

#### Viewpoint-aware Attentive Multi-view Inference for Vehicle Re-identification

> **CVPR, 2018. [(PDF)](/Users/huangkaiwen/Desktop/Paper/vehicle-reid/2018-Viewpoint-aware Attentive Multi-view.pdf ) ** [link](https://scholar.google.com/scholar?hl=zh-CN&as_sdt=0%2C5&q=Viewpoint-aware+Attentive+Multi-view+Inference+for+Vehicle+Re-identification&btnG=)【引用数 **339**】
>
...
> ```
>
> ![](https://gulinall-hkw.oss-cn-shenzhen.aliyuncs.com/404a5109-adc7-400b-8d35-9737634204ff.png) 
...
> ```
>
> ![](https://gulinall-hkw.oss-cn-shenzhen.aliyuncs.com/e5c082c9-32af-426d-9824-7309790419b6.png)
...
> ```
>
> ![](https://gulinall-hkw.oss-cn-shenzhen.aliyuncs.com/a5f45cc8-26fd-4307-90fa-02d7b58d3faa.png) 
...
>
> <img src="https://gulinall-hkw.oss-cn-shenzhen.aliyuncs.com/d773f887-0b88-47cc-bb07-fdcae176146a.png" style="zoom:50%;" /> 
